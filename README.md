# 
Web-Design-Challenge, Homework 11
Wrtiten by Brian Zdarsky
Special thanks to TA Mohamed Hamza for his extra effort/suppport

For my Submission, I added the following files in the folder loacted at https://github.com/BZNUDS/Web-Design-Challenge
My website is published at https://bznuds.github.io/Web-Design-Challenge/

In this assignment, I: 
    Created a new repository for this project called Web-Design-Challenge
    Cloned the new repository to my computer
    Inside my local git repository, created a directory for the Web-Design-Challenge
    Inside my local git repository, added my **html** files, as well as **assets**, **Resources** and **visualizations** folders. 
    Made my `index.html` the landing page that the user first sees and can be accessed from every other page by clicking on Lattitude in the navbar
    Created/executed a Read_CSV_to_html.ipynb file that converts CSV data to HTML. I then incorporated that data into my data.html file for display purposes
    Created a through READ.me file
...
------------------------------------------------Prior messages to the Central Grader------------------------------------------------------------------------------------
